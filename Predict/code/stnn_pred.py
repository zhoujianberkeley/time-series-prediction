...
def predict_single(data_dir, file, model):
    ...
    # train_data = transform2train(train_data, start_month=start_month)
    # sst, t300, ua, va = prepare_data(train_data)
    # reshape the testing train_data to make it match with the trained model
...
def predict(data_dir='../tcdata/enso_round1_test_20210201',
    ...
    from model_structure import load_model
